...
import { StyleSheet, Image, TouchableOpacity, Text, View, Pressable, Button, } from 'react-native';
import { useRoute } from '@react-navigation/native';
import SpecificCall from "./Specificallcomp";
import axios from '../../services/axiosInstance';
//import {mysort} from '../tempComp'
...
const styles = StyleSheet.create({
    ...
    containerCalls: {
        width: '51%', // Make the alerts container take the entire width
    ...
    alert: {
        width: '99%', // Adjust the width to fit two alerts in a row
